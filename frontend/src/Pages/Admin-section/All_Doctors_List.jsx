...
const All_Doctors_List = () => {
    ...
    useEffect(() => { 
        const fetchDoctors = async () => { 
            try {
                const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/show-all-doctors-list`);
                ...
                <div className="p-6">
                    ...
                    {doctors.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {doctors.map((doctor) => (
                                <div key={doctor.id} className="bg-white shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
...
export default All_Doctors_List;
